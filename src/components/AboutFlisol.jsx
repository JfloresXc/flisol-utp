...
import { Globe, Shield, Zap, Sparkles, Terminal, ChevronRight } from 'lucide-react'
        ...
        >
          <div className="space-y-6">
            ...
            >
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.4em]">Propósito del Sistema</span>
            </motion.div>
            
            <motion.h2 
              variants={itemVariants}
              className="font-display text-6xl md:text-8xl font-black text-white leading-[0.8] tracking-tighter"
            >
              CULTURA <br />
          ...
          <motion.div variants={itemVariants} className="flex items-center gap-8 pt-4">
             ...
             <div className="flex flex-col gap-1">
                ...
                <span className="font-display font-bold text-white tracking-tighter">LEAD_UTP v2.6</span>
             </div>
          </motion.div>
        </motion.div>
        ...
        >
          {stats.map((stat) => (
            <motion.article
              ...
              variants={itemVariants}
              whileHover={{ x: 10 }}
              className="group relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-white/[0.01] p-8 backdrop-blur-sm transition-all hover:border-flisol-orange/30 hover:bg-white/[0.03]"
            >
              <div className="absolute top-0 right-0 p-6 text-[8px] font-mono text-zinc-800 group-hover:text-flisol-orange/20 transition-colors">
                {stat.id}
              </div>
              
              <div className="flex items-start gap-6">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-zinc-900 text-flisol-orange ring-1 ring-white/10 shadow-xl group-hover:scale-110 group-hover:bg-flisol-orange group-hover:text-white transition-all duration-500">
                  {stat.icon}
                </div>
                <div className="space-y-2">
                  <h3 className="font-display text-2xl font-bold text-white group-hover:text-flisol-orange transition-colors tracking-tight">
                    {stat.text}
                  </h3>
