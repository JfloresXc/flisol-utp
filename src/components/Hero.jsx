...
function Hero() {
  ...
  return (
    <section id="inicio" className="hero-pattern relative overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-32">
              ...
              <div className="relative rounded-[2.8rem] border border-white/5 bg-black/60 p-8 sm:p-12 space-y-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-zinc-500">T-Minus Countdown</span>
                  </div>
